                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          CustomText(text: '\$${data['total']}', size: 12),
                          SizedBox(height: 20),
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  CustomText(text: '${data['session_payments']/100}% (\$${data['session_payments']})'),
                                ],
                              )
                            ],
                          ),
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  CustomText(text: '${data['subscriptions']/100}% (\$${data['subscriptions']})'),
                                ],
                              )
                            ],
                          ),
