...
typedef SWIFT_ENUM(NSUInteger, SentryLevel, closed) {
...
typedef SWIFT_ENUM(NSInteger, SentryReplayQuality, closed) {
/// Video Scale: 80%
/// Bit Rate: 20.000
...
typedef SWIFT_ENUM(NSInteger, SentryTransactionNameSource, closed) {
